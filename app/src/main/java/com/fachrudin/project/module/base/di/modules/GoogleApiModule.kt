...
import com.fachrudin.project.module.data.datasource.webapi.GoogleNetworkInterceptor
 ...
 */
@Module
class GoogleApiModule(api: WebApi) : ApiModule(api) {
    ...
    internal fun provideInterceptor(): Interceptor {
        return GoogleNetworkInterceptor(api)
    }
