...
import com.fachrudin.project.core.common.AndroidContext
 ...
 * @date 21-Mar-19
 */
class UserDetailViewModel @Inject constructor(private val getUserListInteractor: GetUserListInteractor) : BaseViewModel() {
    ...
    fun getUserListFromApi() {
        GlobalScope.launch(AndroidContext.UI) {
            try {
