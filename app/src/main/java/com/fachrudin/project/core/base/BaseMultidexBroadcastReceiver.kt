 ...
 * @date 21-Nov-18
 */
abstract class BaseMultidexBroadcastReceiver : BroadcastReceiver(), ComponentOwner<FeatureComponent> {

    override val component: FeatureComponent by lazy { buildComponent() }
    private var application: BaseMultidexApplication? = null
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        this.application = context?.applicationContext as BaseMultidexApplication
        injectComponent()
    }
}
